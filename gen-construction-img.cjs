...
async function main() {
  console.log('Generating construction image...');
  const result = await fal.subscribe('fal-ai/nano-banana-2', {
    input: {
      prompt: 'Professional post-construction cleaning of a brand new modern commercial building interior. Large open space with polished concrete floors, floor-to-ceiling windows, fresh white walls, professional cleaning crew in uniform with industrial equipment working. South Florida commercial construction, bright natural daylight, photorealistic, no text.',
      aspect_ratio: '16:9',
      resolution: '2K',
      output_format: 'jpeg',
      num_images: 1,
